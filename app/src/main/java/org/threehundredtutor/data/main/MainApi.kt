...
object MainApi {
    const val TUTOR_SUBJECT_QUERY_GET_ALL_WITH_ICONS_CACHED =
        "/api/tutor/subject/query/GetAll/with-icons/Cached"

    const val TUTOR_STUDENT_GROUP_QUERY_SEARCH_WITH_PROGRESSES =
