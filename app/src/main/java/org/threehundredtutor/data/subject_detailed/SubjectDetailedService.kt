...
import org.threehundredtutor.data.subject_detailed.SubjectDetailedApi.TUTOR_SUBJECT_MENU_GET_BY_ALIAS_OR_ID_CACHED
...
interface SubjectDetailedService {
    @GET(TUTOR_SUBJECT_MENU_GET_BY_ALIAS_OR_ID_CACHED)
